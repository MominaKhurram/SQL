...
SELECT 
    AVG(DATEDIFF(annual_plan_start_date, join_date)) AS average_days_to_annual_plan
FROM 
    AnnualPlanCustomers;
...
SELECT 
    join_date,
    upgrade_date AS annual_plan_start_date,
    difference_in_days,
    AVG(difference_in_days) OVER() AS average_days_to_annual_plan
-- sum of all values in the "difference_in_days" column and divides it by the total number of rows.
FROM 
    AnnualPlanUpgrades;
